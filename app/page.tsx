...
export default function Home() {
  return <main id="top">
    <header className="issue-nav" aria-label="Primary navigation"><a className="issue-mark" href="#top" aria-label="Akshat Kadam, home">AK<span>!</span></a><p className="issue-number">PERSONAL ARCHIVE / ISSUE <AgeIssue /></p><nav><a href="#origin">My Story</a><a href="#work">9–5</a><a href="#now">5–9</a><a href="/bookshelf">Bookshelf</a></nav></header>
    <CoverReader />
